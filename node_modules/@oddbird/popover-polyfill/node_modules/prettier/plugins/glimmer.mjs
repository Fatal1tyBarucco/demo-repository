...
`:"",c=new Error(`${t}: ${l}(error occurred in '${r}' @ line ${s} : column ${i})`);return c.name="SyntaxError",c.location=e,c.code=a,c}var yi={Program:["body"],Template:["body"],Block:["body"],MustacheStatement:["path","params","hash"],BlockStatement:["path","params","hash","program","inverse"],ElementModifierStatement:["path","params","hash"],PartialStatement:["name","params","hash"],CommentStatement:[],MustacheCommentStatement:[],ElementNode:["attributes","modifiers","children","comments"],AttrNode:["value"],TextNode:[],ConcatStatement:["parts"],SubExpression:["path","params","hash"],PathExpression:[],PathHead:[],StringLiteral:[],BooleanLiteral:[],NumberLiteral:[],NullLiteral:[],UndefinedLiteral:[],Hash:["pairs"],HashPair:["value"],NamedBlock:["attributes","modifiers","children","comments"],SimpleElement:["attributes","modifiers","children","comments"],Component:["head","attributes","modifiers","children","comments"]},Or=function(){t.prototype=Object.create(Error.prototype),t.prototype.constructor=t;function t(e,r,n,s){let i=Error.call(this,e);this.key=s,this.message=e,this.node=r,this.parent=n,i.stack&&(this.stack=i.stack)}return t}();function _n(t,e,r){return new Or("Cannot remove a node unless it is part of an array",t,e,r)}function Ei(t,e,r){return new Or("Cannot replace a node with multiple nodes unless it is part of an array",t,e,r)}function Dn(t,e){return new Or("Replacing and removing in key handlers is not yet supported.",t,null,e)}var Ve=class{node;parent;parentKey;constructor(e){let r=arguments.length>1&&arguments[1]!==void 0?arguments[1]:null,n=arguments.length>2&&arguments[2]!==void 0?arguments[2]:null;this.node=e,this.parent=r,this.parentKey=n}get parentNode(){return this.parent?this.parent.node:null}parents(){return{[Symbol.iterator]:()=>new Pr(this)}}},Pr=class{path;constructor(e){this.path=e}next(){return this.path.parent?(this.path=this.path.parent,{done:!1,value:this.path}):{done:!0,value:null}}};function Hn(t){return typeof t=="function"?t:t.enter}function qn(t){if(typeof t!="function")return t.exit}function Si(t,e){let r=typeof t!="function"?t.keys:void 0;if(r===void 0)return;let n=r[e];return n!==void 0?n:r.All}function ki(t,e){if((e==="Template"||e==="Block")&&t.Program)return t.Program;let r=t[e];return r!==void 0?r:t.All}function Bt(t,e){let{node:r,parent:n,parentKey:s}=e,i=ki(t,r.type),a,l;i!==void 0&&(a=Hn(i),l=qn(i));let c;if(a!==void 0&&(c=a(r,e)),c!=null)if(JSON.stringify(r)===JSON.stringify(c))c=void 0;else{if(Array.isArray(c))return Vn(t,c,n,s),c;{let h=new Ve(c,n,s);return Bt(t,h)||c}}if(c===void 0){let h=yi[r.type];for(let g=0;g<h.length;g++){let E=h[g];Ti(t,i,e,E)}l!==void 0&&(c=l(r,e))}return c}function wi(t,e){return t[e]}function On(t,e,r){t[e]=r}function Ti(t,e,r,n){let{node:s}=r,i=wi(s,n);if(!i)return;let a,l;if(e!==void 0){let c=Si(e,n);c!==void 0&&(a=Hn(c),l=qn(c))}if(a!==void 0&&a(s,n)!==void 0)throw Dn(s,n);if(Array.isArray(i))Vn(t,i,r,n);else{let c=new Ve(i,r,n),h=Bt(t,c);h!==void 0&&Ni(s,n,i,h)}if(l!==void 0&&l(s,n)!==void 0)throw Dn(s,n)}function Vn(t,e,r,n){for(let s=0;s<e.length;s++){let i=Z(e[s]),a=new Ve(i,r,n),l=Bt(t,a);l!==void 0&&(s+=vi(e,s,l)-1)}}function Ni(t,e,r,n){if(n===null)throw _n(r,t,e);if(Array.isArray(n))if(n.length===1)On(t,e,n[0]);else throw n.length===0?_n(r,t,e):Ei(r,t,e);else On(t,e,n)}function vi(t,e,r){return r===null?(t.splice(e,1),0):Array.isArray(r)?(t.splice(e,1,...r),r.length):(t.splice(e,1,r),1)}function Ai(t,e){let r=new Ve(t);Bt(e,r)}var Pi=/[!"#%&'()*+./;<=>@[\\\]^`{|}~]/u;function xi(t){let e=Ci(t);e&&(t.blockParams=e)}function Ci(t){let e=t.attributes.length,r=[];for(let s=0;s<e;s++)r.push(Z(t.attributes[s]).name);let n=r.indexOf("as");if(n===-1&&r.length>0&&Z(r[r.length-1]).charAt(0)==="|")throw S("Block parameters must be preceded by the `as` keyword, detected block parameters without `as`",t.loc);if(n!==-1&&e>n&&Z(r[n+1]).charAt(0)==="|"){let s=r.slice(n).join(" ");if(s.charAt(s.length-1)!=="|"||ar(s.match(/\|/gu),"block params must exist here").length!==2)throw S("Invalid block parameters syntax, '"+s+"'",t.loc);let i=[];for(let a=n+1;a<e;a++){let l=Z(r[a]).replace(/\|/gu,"");if(l!==""){if(Pi.test(l))throw S("Invalid identifier for block parameters, '"+l+"'",t.loc);i.push(l)}}if(i.length===0)throw S("Cannot use zero block parameters",t.loc);return t.attributes=t.attributes.slice(0,n),i}return null}function Li(t){switch(t.type){case"Block":case"Template":return t.body;case"ElementNode":return t.children}}function He(t,e){Li(t).push(e)}function Un(t){return t.type==="StringLiteral"||t.type==="BooleanLiteral"||t.type==="NumberLiteral"||t.type==="NullLiteral"||t.type==="UndefinedLiteral"}function _i(t){return t.type==="UndefinedLiteral"?"undefined":JSON.stringify(t.value)}var yr;function Er(){return yr||(yr=new we("","(synthetic)")),yr}function Di(t,e,r,n,s,i){return typeof t=="string"&&(t=ct(t)),{type:"MustacheStatement",path:t,params:e||[],hash:r||Ue([]),escaped:!n,trusting:!!n,loc:k(s||null),strip:i||{open:!1,close:!1}}}function Oi(t,e,r,n,s,i,a,l,c){let h,g;return n.type==="Template"?h=nt({},n,{type:"Block"}):h=n,s!=null&&s.type==="Template"?g=nt({},s,{type:"Block"}):g=s,{type:"BlockStatement",path:ct(t),params:e||[],hash:r||Ue([]),program:h||null,inverse:g||null,loc:k(i||null),openStrip:a||{open:!1,close:!1},inverseStrip:l||{open:!1,close:!1},closeStrip:c||{open:!1,close:!1}}}function Bi(t,e,r,n){return{type:"ElementModifierStatement",path:ct(t),params:e||[],hash:r||Ue([]),loc:k(n||null)}}function Ii(t,e,r,n,s){return{type:"PartialStatement",name:t,params:e||[],hash:r||Ue([]),indent:n||"",strip:{open:!1,close:!1},loc:k(s||null)}}function Ri(t,e){return{type:"CommentStatement",value:t,loc:k(e||null)}}function Hi(t,e){return{type:"MustacheCommentStatement",value:t,loc:k(e||null)}}function qi(t,e){if(!Se(t))throw new Error("b.concat requires at least one part");return{type:"ConcatStatement",parts:t||[],loc:k(e||null)}}function Vi(t){let e=arguments.length>1&&arguments[1]!==void 0?arguments[1]:{},{attrs:r,blockParams:n,modifiers:s,comments:i,children:a,loc:l}=e,c,h=!1;return typeof t=="object"?(h=t.selfClosing,c=t.name):t.slice(-1)==="/"?(c=t.slice(0,-1),h=!0):c=t,{type:"ElementNode",tag:c,selfClosing:h,attributes:r||[],blockParams:n||[],modifiers:s||[],comments:i||[],children:a||[],loc:k(l||null)}}function Ui(t,e,r){return{type:"AttrNode",name:t,value:e,loc:k(r||null)}}function Fi(t,e){return{type:"TextNode",chars:t||"",loc:k(e||null)}}function Mi(t,e,r,n){return{type:"SubExpression",path:ct(t),params:e||[],hash:r||Ue([]),loc:k(n||null)}}function Fn(t){switch(t.type){case"AtHead":return{original:t.name,parts:[t.name]};case"ThisHead":return{original:"this",parts:[]};case"VarHead":return{original:t.name,parts:[t.name]}}}function Bn(t,e){let[r,...n]=wt(t.split(".")),s;return r==="this"?s={type:"ThisHead",loc:k(e||null)}:r[0]==="@"?s={type:"AtHead",name:r,loc:k(e||null)}:s={type:"VarHead",name:r,loc:k(e||null)},{head:s,tail:n}}function Mn(t){return{type:"ThisHead",loc:k(t||null)}}function Gn(t,e){return P(t[0]==="@","call builders.at() with a string that starts with '@'"),{type:"AtHead",name:t,loc:k(e||null)}}function Yn(t,e){return P(t!=="this","You called builders.var() with 'this'. Call builders.this instead"),P(t[0]!=="@",`You called builders.var() with '${t}'. Call builders.at('${t}') instead`),{type:"VarHead",name:t,loc:k(e||null)}}function Gi(t,e){return t[0]==="@"?Gn(t,e):t==="this"?Mn(e):Yn(t,e)}function Yi(t,e){return{type:"NamedBlockName",name:t,loc:k(e||null)}}function zi(t,e,r){let{original:n,parts:s}=Fn(t),i=[...s,...e],a=[...n,...i].join(".");return new Ne(a,t,e,k(r||null))}function ct(t,e){if(typeof t!="string"){if("type"in t)return t;{let{head:s,tail:i}=Bn(t.head,I.broken());P(i.length===0,"builder.path({ head, tail }) should not be called with a head with dots in it");let{original:a}=Fn(s);return new Ne([a,...i].join("."),s,i,k(e||null))}}let{head:r,tail:n}=Bn(t,I.broken());return new Ne(t,r,n,k(e||null))}function _t(t,e,r){return{type:t,value:e,original:e,loc:k(r||null)}}function Ue(t,e){return{type:"Hash",pairs:t||[],loc:k(e||null)}}function Wi(t,e,r){return{type:"HashPair",key:t,value:e,loc:k(r||null)}}function Ki(t,e,r){return{type:"Template",body:t||[],blockParams:e||[],loc:k(r||null)}}function ji(t,e){let r=arguments.length>2&&arguments[2]!==void 0?arguments[2]:!1,n=arguments.length>3?arguments[3]:void 0;return{type:"Block",body:t||[],blockParams:e||[],chained:r,loc:k(n||null)}}function $i(t,e,r){return{type:"Template",body:t||[],blockParams:e||[],loc:k(r||null)}}function Qi(t,e){return{line:t,column:e}}function k(){for(var t=arguments.length,e=new Array(t),r=0;r<t;r++)e[r]=arguments[r];if(e.length===1){let n=e[0];return n&&typeof n=="object"?I.forHbsLoc(Er(),n):I.forHbsLoc(Er(),mi)}else{let[n,s,i,a,l]=e,c=l?new we("",l):Er();return I.forHbsLoc(c,{start:{line:n,column:s},end:{line:i,column:a}})}}var Xi={mustache:Di,block:Oi,partial:Ii,comment:Ri,mustacheComment:Hi,element:Vi,elementModifier:Bi,attr:Ui,text:Fi,sexpr:Mi,concat:qi,hash:Ue,pair:Wi,literal:_t,program:Ki,blockItself:ji,template:$i,loc:k,pos:Qi,path:ct,fullPath:zi,head:Gi,at:Gn,var:Yn,this:Mn,blockName:Yi,string:Sr("StringLiteral"),boolean:Sr("BooleanLiteral"),number:Sr("NumberLiteral"),undefined(){return _t("UndefinedLiteral",void 0)},null(){return _t("NullLiteral",null)}};function Sr(t){return function(e,r){return _t(t,e,r)}}var Ne=class{type="PathExpression";parts;this=!1;data=!1;constructor(e,r,n,s){this.original=e,this.loc=s;let i=n.slice();r.type==="ThisHead"?this.this=!0:r.type==="AtHead"?(this.data=!0,i.unshift(r.name.slice(1))):i.unshift(r.name),this.parts=i}_head=void 0;get head(){if(this._head)return this._head;let e;this.this?e="this":this.data?e=`@${Nt(wt(this.parts))}`:(rt(this.parts),e=Nt(this.parts));let r=this.loc.collapse("start").sliceStartChars({chars:e.length}).loc;return this._head=Xi.head(e,r)}get tail(){return this.this?this.parts:this.parts.slice(1)}},Lt={close:!1,open:!1},xr=class{pos(e,r){return{line:e,column:r}}blockItself(e){let{body:r=[],blockParams:n=[],chained:s=!1,loc:i}=e;return{type:"Block",body:r,blockParams:n,chained:s,loc:i}}template(e){let{body:r,blockParams:n,loc:s}=e;return{type:"Template",body:r||[],blockParams:n||[],loc:s}}mustache(e){let{path:r,params:n,hash:s,trusting:i,loc:a,strip:l=Lt}=e;return{type:"MustacheStatement",path:r,params:n,hash:s,escaped:!i,trusting:i,loc:a,strip:l||{open:!1,close:!1}}}block(e){let{path:r,params:n,hash:s,defaultBlock:i,elseBlock:a=null,loc:l,openStrip:c=Lt,inverseStrip:h=Lt,closeStrip:g=Lt}=e;return{type:"BlockStatement",path:r,params:n,hash:s,program:i,inverse:a,loc:l,openStrip:c,inverseStrip:h,closeStrip:g}}comment(e,r){return{type:"CommentStatement",value:e,loc:r}}mustacheComment(e,r){return{type:"MustacheCommentStatement",value:e,loc:r}}concat(e,r){return{type:"ConcatStatement",parts:e,loc:r}}element(e){let{tag:r,selfClosing:n,attrs:s,blockParams:i,modifiers:a,comments:l,children:c,loc:h}=e;return{type:"ElementNode",tag:r,selfClosing:n,attributes:s||[],blockParams:i||[],modifiers:a||[],comments:l||[],children:c||[],loc:h}}elementModifier(e){let{path:r,params:n,hash:s,loc:i}=e;return{type:"ElementModifierStatement",path:r,params:n,hash:s,loc:i}}attr(e){let{name:r,value:n,loc:s}=e;return{type:"AttrNode",name:r,value:n,loc:s}}text(e){let{chars:r,loc:n}=e;return{type:"TextNode",chars:r,loc:n}}sexpr(e){let{path:r,params:n,hash:s,loc:i}=e;return{type:"SubExpression",path:r,params:n,hash:s,loc:i}}path(e){let{head:r,tail:n,loc:s}=e,{original:i}=Ji(r),a=[...i,...n].join(".");return new Ne(a,r,n,s)}head(e,r){return e[0]==="@"?this.atName(e,r):e==="this"?this.this(r):this.var(e,r)}this(e){return{type:"ThisHead",loc:e}}atName(e,r){return P(e[0]==="@","call builders.at() with a string that starts with '@'"),{type:"AtHead",name:e,loc:r}}var(e,r){return P(e!=="this","You called builders.var() with 'this'. Call builders.this instead"),P(e[0]!=="@",`You called builders.var() with '${e}'. Call builders.at('${e}') instead`),{type:"VarHead",name:e,loc:r}}hash(e,r){return{type:"Hash",pairs:e||[],loc:r}}pair(e){let{key:r,value:n,loc:s}=e;return{type:"HashPair",key:r,value:n,loc:s}}literal(e){let{type:r,value:n,loc:s}=e;return{type:r,value:n,original:n,loc:s}}undefined(){return this.literal({type:"UndefinedLiteral",value:void 0})}null(){return this.literal({type:"NullLiteral",value:null})}string(e,r){return this.literal({type:"StringLiteral",value:e,loc:r})}boolean(e,r){return this.literal({type:"BooleanLiteral",value:e,loc:r})}number(e,r){return this.literal({type:"NumberLiteral",value:e,loc:r})}};function Ji(t){switch(t.type){case"AtHead":return{original:t.name,parts:[t.name]};case"ThisHead":return{original:"this",parts:[]};case"VarHead":return{original:t.name,parts:[t.name]}}}var N=new xr,Cr=class{elementStack=[];lines;source;currentAttribute=null;currentNode=null;tokenizer;constructor(e){let r=arguments.length>1&&arguments[1]!==void 0?arguments[1]:new mr(xn),n=arguments.length>2&&arguments[2]!==void 0?arguments[2]:"precompile";this.source=e,this.lines=e.source.split(/\r\n?|\n/u),this.tokenizer=new gr(this,r,n)}offset(){let{line:e,column:r}=this.tokenizer;return this.source.offsetFor(e,r)}pos(e){let{line:r,column:n}=e;return this.source.offsetFor(r,n)}finish(e){return nt({},e,{loc:e.loc.until(this.offset())})}get currentAttr(){return ar(this.currentAttribute,"expected attribute")}get currentTag(){let e=this.currentNode;return P(e&&(e.type==="StartTag"||e.type==="EndTag"),"expected tag"),e}get currentStartTag(){let e=this.currentNode;return P(e&&e.type==="StartTag","expected start tag"),e}get currentEndTag(){let e=this.currentNode;return P(e&&e.type==="EndTag","expected end tag"),e}get currentComment(){let e=this.currentNode;return P(e&&e.type==="CommentStatement","expected a comment"),e}get currentData(){let e=this.currentNode;return P(e&&e.type==="TextNode","expected a text node"),e}acceptTemplate(e){return this[e.type](e)}acceptNode(e){return this[e.type](e)}currentElement(){return Tt(wt(this.elementStack))}sourceForNode(e,r){let n=e.loc.start.line-1,s=n-1,i=e.loc.start.column,a=[],l,c,h;for(r?(c=r.loc.end.line-1,h=r.loc.end.column):(c=e.loc.end.line-1,h=e.loc.end.column);s<c;)s++,l=Z(this.lines[s]),s===n?n===c?a.push(l.slice(i,h)):a.push(l.slice(i)):s===c?a.push(l.slice(0,h)):a.push(l);return a.join(`
`)}},In="beforeAttributeName",Zi="attributeValueUnquoted",Lr=class extends Cr{get isTopLevel(){return this.elementStack.length===0}Program(e){let r=[],n;this.isTopLevel?n=N.template({body:r,blockParams:e.blockParams,loc:this.source.spanFor(e.loc)}):n=N.blockItself({body:r,blockParams:e.blockParams,chained:e.chained,loc:this.source.spanFor(e.loc)});let s,i=e.body.length;if(this.elementStack.push(n),i===0)return this.elementStack.pop();for(s=0;s<i;s++)this.acceptNode(Z(e.body[s]));let a=this.elementStack.pop();if(a!==n){let l=a;throw S(`Unclosed element \`${l.tag}\``,l.loc)}return n}BlockStatement(e){if(this.tokenizer.state==="comment"){this.appendToCommentData(this.sourceForNode(e));return}if(this.tokenizer.state!=="data"&&this.tokenizer.state!=="beforeData")throw S("A block may only be used inside an HTML element or another block.",this.source.spanFor(e.loc));let{path:r,params:n,hash:s}=kr(this,e);e.program.loc||(e.program.loc=Dt),e.inverse&&!e.inverse.loc&&(e.inverse.loc=Dt);let i=this.Program(e.program),a=e.inverse?this.Program(e.inverse):null,l=N.block({path:r,params:n,hash:s,defaultBlock:i,elseBlock:a,loc:this.source.spanFor(e.loc),openStrip:e.openStrip,inverseStrip:e.inverseStrip,closeStrip:e.closeStrip}),c=this.currentElement();He(c,l)}MustacheStatement(e){let{tokenizer:r}=this;if(r.state==="comment"){this.appendToCommentData(this.sourceForNode(e));return}let n,{escaped:s,loc:i,strip:a}=e;if(Un(e.path))n=N.mustache({path:this.acceptNode(e.path),params:[],hash:N.hash([],this.source.spanFor(e.path.loc).collapse("end")),trusting:!s,loc:this.source.spanFor(i),strip:a});else{let{path:l,params:c,hash:h}=kr(this,e);n=N.mustache({path:l,params:c,hash:h,trusting:!s,loc:this.source.spanFor(i),strip:a})}switch(r.state){case"tagOpen":case"tagName":throw S("Cannot use mustaches in an elements tagname",n.loc);case"beforeAttributeName":wr(this.currentStartTag,n);break;case"attributeName":case"afterAttributeName":this.beginAttributeValue(!1),this.finishAttributeValue(),wr(this.currentStartTag,n),r.transitionTo(In);break;case"afterAttributeValueQuoted":wr(this.currentStartTag,n),r.transitionTo(In);break;case"beforeAttributeValue":this.beginAttributeValue(!1),this.appendDynamicAttributeValuePart(n),r.transitionTo(Zi);break;case"attributeValueDoubleQuoted":case"attributeValueSingleQuoted":case"attributeValueUnquoted":this.appendDynamicAttributeValuePart(n);break;default:He(this.currentElement(),n)}return n}appendDynamicAttributeValuePart(e){this.finalizeTextPart();let r=this.currentAttr;r.isDynamic=!0,r.parts.push(e)}finalizeTextPart(){let r=this.currentAttr.currentPart;r!==null&&(this.currentAttr.parts.push(r),this.startTextPart())}startTextPart(){this.currentAttr.currentPart=null}ContentStatement(e){ta(this.tokenizer,e),this.tokenizer.tokenizePart(e.value),this.tokenizer.flushData()}CommentStatement(e){let{tokenizer:r}=this;if(r.state==="comment")return this.appendToCommentData(this.sourceForNode(e)),null;let{value:n,loc:s}=e,i=N.mustacheComment(n,this.source.spanFor(s));switch(r.state){case"beforeAttributeName":case"afterAttributeName":this.currentStartTag.comments.push(i);break;case"beforeData":case"data":He(this.currentElement(),i);break;default:throw S(`Using a Handlebars comment when in the \`${r.state}\` state is not supported`,this.source.spanFor(e.loc))}return i}PartialStatement(e){throw S("Handlebars partials are not supported",this.source.spanFor(e.loc))}PartialBlockStatement(e){throw S("Handlebars partial blocks are not supported",this.source.spanFor(e.loc))}Decorator(e){throw S("Handlebars decorators are not supported",this.source.spanFor(e.loc))}DecoratorBlock(e){throw S("Handlebars decorator blocks are not supported",this.source.spanFor(e.loc))}SubExpression(e){let{path:r,params:n,hash:s}=kr(this,e);return N.sexpr({path:r,params:n,hash:s,loc:this.source.spanFor(e.loc)})}PathExpression(e){let{original:r}=e,n;if(r.indexOf("/")!==-1){if(r.slice(0,2)==="./")throw S('Using "./" is not supported in Glimmer and unnecessary',this.source.spanFor(e.loc));if(r.slice(0,3)==="../")throw S('Changing context using "../" is not supported in Glimmer',this.source.spanFor(e.loc));if(r.indexOf(".")!==-1)throw S("Mixing '.' and '/' in paths is not supported in Glimmer; use only '.' to separate property paths",this.source.spanFor(e.loc));n=[e.parts.join("/")]}else{if(r===".")throw S("'.' is not a supported path in Glimmer; check for a path with a trailing '.'",this.source.spanFor(e.loc));n=e.parts}let s=!1;/^this(?:\..+)?$/u.test(r)&&(s=!0);let i;if(s)i={type:"ThisHead",loc:{start:e.loc.start,end:{line:e.loc.start.line,column:e.loc.start.column+4}}};else if(e.data){let a=n.shift();if(a===void 0)throw S("Attempted to parse a path expression, but it was not valid. Paths beginning with @ must start with a-z.",this.source.spanFor(e.loc));i={type:"AtHead",name:`@${a}`,loc:{start:e.loc.start,end:{line:e.loc.start.line,column:e.loc.start.column+a.length+1}}}}else{let a=n.shift();if(a===void 0)throw S("Attempted to parse a path expression, but it was not valid. Paths must start with a-z or A-Z.",this.source.spanFor(e.loc));i={type:"VarHead",name:a,loc:{start:e.loc.start,end:{line:e.loc.start.line,column:e.loc.start.column+a.length}}}}return new Ne(e.original,i,n,this.source.spanFor(e.loc))}Hash(e){let r=e.pairs.map(n=>N.pair({key:n.key,value:this.acceptNode(n.value),loc:this.source.spanFor(n.loc)}));return N.hash(r,this.source.spanFor(e.loc))}StringLiteral(e){return N.literal({type:"StringLiteral",value:e.value,loc:e.loc})}BooleanLiteral(e){return N.literal({type:"BooleanLiteral",value:e.value,loc:e.loc})}NumberLiteral(e){return N.literal({type:"NumberLiteral",value:e.value,loc:e.loc})}UndefinedLiteral(e){return N.literal({type:"UndefinedLiteral",value:void 0,loc:e.loc})}NullLiteral(e){return N.literal({type:"NullLiteral",value:null,loc:e.loc})}};function ea(t,e){if(e==="")return{lines:t.split(`
`).length-1,columns:0};let[r]=t.split(e),n=r.split(/\n/u),s=n.length-1;return{lines:s,columns:Z(n[s]).length}}function ta(t,e){let r=e.loc.start.line,n=e.loc.start.column,s=ea(e.original,e.value);r=r+s.lines,s.lines?n=s.columns:n=n+s.columns,t.line=r,t.column=n}function kr(t,e){if(e.path.type.endsWith("Literal")){let a=e.path,l="";throw a.type==="BooleanLiteral"?l=a.original.toString():a.type==="StringLiteral"?l=`"${a.original}"`:a.type==="NullLiteral"?l="null":a.type==="NumberLiteral"?l=a.value.toString():l="undefined",S(`${a.type} "${a.type==="StringLiteral"?a.original:l}" cannot be called as a sub-expression, replace (${l}) with ${l}`,t.source.spanFor(a.loc))}let r=e.path.type==="PathExpression"?t.PathExpression(e.path):t.SubExpression(e.path),n=e.params?e.params.map(a=>t.acceptNode(a)):[],s=Se(n)?Tt(n).loc:r.loc,i=e.hash?t.Hash(e.hash):{type:"Hash",pairs:[],loc:t.source.spanFor(s).collapse("end")};return{path:r,params:n,hash:i}}function wr(t,e){let{path:r,params:n,hash:s,loc:i}=e;if(Un(r)){let l=`{{${_i(r)}}}`,c=`<${t.name} ... ${l} ...`;throw S(`In ${c}, ${l} is not a valid modifier`,e.loc)}let a=N.elementModifier({path:r,params:n,hash:s,loc:i});t.modifiers.push(a)}var _r=class extends Lr{tagOpenLine=0;tagOpenColumn=0;reset(){this.currentNode=null}beginComment(){this.currentNode=N.comment("",this.source.offsetFor(this.tagOpenLine,this.tagOpenColumn))}appendToCommentData(e){this.currentComment.value+=e}finishComment(){He(this.currentElement(),this.finish(this.currentComment))}beginData(){this.currentNode=N.text({chars:"",loc:this.offset().collapsed()})}appendToData(e){this.currentData.chars+=e}finishData(){this.currentData.loc=this.currentData.loc.withEnd(this.offset()),He(this.currentElement(),this.currentData)}tagOpen(){this.tagOpenLine=this.tokenizer.line,this.tagOpenColumn=this.tokenizer.column}beginStartTag(){this.currentNode={type:"StartTag",name:"",attributes:[],modifiers:[],comments:[],selfClosing:!1,loc:this.source.offsetFor(this.tagOpenLine,this.tagOpenColumn)}}beginEndTag(){this.currentNode={type:"EndTag",name:"",attributes:[],modifiers:[],comments:[],selfClosing:!1,loc:this.source.offsetFor(this.tagOpenLine,this.tagOpenColumn)}}finishTag(){let e=this.finish(this.currentTag);if(e.type==="StartTag"){if(this.finishStartTag(),e.name===":")throw S("Invalid named block named detected, you may have created a named block without a name, or you may have began your name with a number. Named blocks must have names that are at least one character long, and begin with a lower case letter",this.source.spanFor({start:this.currentTag.loc.toJSON(),end:this.offset().toJSON()}));(Ln.has(e.name)||e.selfClosing)&&this.finishEndTag(!0)}else e.type==="EndTag"&&this.finishEndTag(!1)}finishStartTag(){let{name:e,attributes:r,modifiers:n,comments:s,selfClosing:i,loc:a}=this.finish(this.currentStartTag),l=N.element({tag:e,selfClosing:i,attrs:r,modifiers:n,comments:s,children:[],blockParams:[],loc:a});this.elementStack.push(l)}finishEndTag(e){let r=this.finish(this.currentTag),n=this.elementStack.pop();this.validateEndTag(r,n,e);let s=this.currentElement();n.loc=n.loc.withEnd(this.offset()),xi(n),He(s,n)}markTagAsSelfClosing(){this.currentTag.selfClosing=!0}appendToTagName(e){this.currentTag.name+=e}beginAttribute(){let e=this.offset();this.currentAttribute={name:"",parts:[],currentPart:null,isQuoted:!1,isDynamic:!1,start:e,valueSpan:e.collapsed()}}appendToAttributeName(e){this.currentAttr.name+=e}beginAttributeValue(e){this.currentAttr.isQuoted=e,this.startTextPart(),this.currentAttr.valueSpan=this.offset().collapsed()}appendToAttributeValue(e){let r=this.currentAttr.parts,n=r[r.length-1],s=this.currentAttr.currentPart;if(s)s.chars+=e,s.loc=s.loc.withEnd(this.offset());else{let i=this.offset();e===`
`?i=n?n.loc.getEnd():this.currentAttr.valueSpan.getStart():i=i.move(-1),this.currentAttr.currentPart=N.text({chars:e,loc:i.collapsed()})}}finishAttributeValue(){this.finalizeTextPart();let e=this.currentTag,r=this.offset();if(e.type==="EndTag")throw S("Invalid end tag: closing tag must not have attributes",this.source.spanFor({start:e.loc.toJSON(),end:r.toJSON()}));let{name:n,parts:s,start:i,isQuoted:a,isDynamic:l,valueSpan:c}=this.currentAttr,h=this.assembleAttributeValue(s,a,l,i.until(r));h.loc=c.withEnd(r);let g=N.attr({name:n,value:h,loc:i.until(r)});this.currentStartTag.attributes.push(g)}reportSyntaxError(e){throw S(e,this.offset().collapsed())}assembleConcatenatedValue(e){for(let s of e)if(s.type!=="MustacheStatement"&&s.type!=="TextNode")throw S(`Unsupported node in quoted attribute value: ${s.type}`,s.loc);rt(e,"the concatenation parts of an element should not be empty");let r=Nt(e),n=Tt(e);return N.concat(e,this.source.spanFor(r.loc).extend(this.source.spanFor(n.loc)))}validateEndTag(e,r,n){if(Ln.has(e.name)&&!n)throw S(`<${e.name}> elements do not need end tags. You should remove it`,e.loc);if(r.tag===void 0)throw S(`Closing tag </${e.name}> without an open tag`,e.loc);if(r.tag!==e.name)throw S(`Closing tag </${e.name}> did not match last open tag <${r.tag}> (on line ${r.loc.startPosition.line})`,e.loc)}assembleAttributeValue(e,r,n,s){if(n){if(r)return this.assembleConcatenatedValue(e);{rt(e);let[i,a]=e;if(a===void 0||a.type==="TextNode"&&a.chars==="/")return i;throw S("An unquoted attribute value must be a string or a mustache, preceded by whitespace or a '=' character, and followed by whitespace, a '>' character, or '/>'",s)}}else return Se(e)?e[0]:N.text({chars:"",loc:s})}},ra={},Dr=class extends mr{constructor(){super({})}parse(){}};function zn(t){var c,h;let e=arguments.length>1&&arguments[1]!==void 0?arguments[1]:{},r=e.mode||"precompile",n,s;typeof t=="string"?(n=new we(t,(c=e.meta)==null?void 0:c.moduleName),r==="codemod"?s=Ct(t,e.parseOptions):s=dr(t,e.parseOptions)):t instanceof we?(n=t,r==="codemod"?s=Ct(t.source,e.parseOptions):s=dr(t.source,e.parseOptions)):(n=new we("",(h=e.meta)==null?void 0:h.moduleName),s=t);let i;r==="codemod"&&(i=new Dr);let a=I.forCharPositions(n,0,n.source.length);s.loc={source:"(program)",start:a.startPosition,end:a.endPosition};let l=new _r(n,i,r).acceptTemplate(s);if(e.strictMode&&(l.blockParams=e.locals??[]),e&&e.plugins&&e.plugins.ast)for(let g of e.plugins.ast){let E=nt({},e,{syntax:ra},{plugins:void 0}),M=g(E);Ai(l,M.visitor)}return l}var Br=function(t){return t.Helper="Helper",t.Modifier="Modifier",t.Component="Component",t}({}),Zo=Br.Helper,el=Br.Modifier,tl=Br.Component;var It=`
`,Wn="\r",Kn=function(){function t(e){this.length=e.length;for(var r=[0],n=0;n<e.length;)switch(e[n]){case It:n+=It.length,r.push(n);break;case Wn:n+=Wn.length,e[n]===It&&(n+=It.length),r.push(n);break;default:n++;break}this.offsets=r}return t.prototype.locationForIndex=function(e){if(e<0||e>this.length)return null;for(var r=0,n=this.offsets;n[r+1]<=e;)r++;var s=e-n[r];return{line:r,column:s}},t.prototype.indexForLocation=function(e){var r=e.line,n=e.column;return r<0||r>=this.offsets.length||n<0||n>this.lengthOfLine(r)?null:this.offsets[r]+n},t.prototype.lengthOfLine=function(e){var r=this.offsets[e],n=e===this.offsets.length-1?this.length:this.offsets[e+1];return n-r},t}();function na(t,e){let r=new SyntaxError(t+" ("+e.loc.start.line+":"+e.loc.start.column+")");return Object.assign(r,e)}var jn=na;function sa(t){let e=t.children??t.body;if(e)for(let r=0;r<e.length-1;r++)e[r].type==="TextNode"&&e[r+1].type==="MustacheStatement"&&(e[r].chars=e[r].chars.replace(/\\$/,"\\\\"))}function ia(t){let e=new Kn(t),r=({line:s,column:i})=>e.indexForLocation({line:s-1,column:i}),n=s=>{let{start:i,end:a}=s.loc;i.offset=r(i),a.offset=r(a)};return()=>({name:"prettierParsePlugin",visitor:{All(s){n(s),sa(s)}}})}function aa(t){let e;try{e=zn(t,{mode:"codemod",plugins:{ast:[ia(t)]}})}catch(r){let n=la(r);if(n){let s=oa(r);throw jn(s,{loc:n,cause:r})}throw r}return e}function oa(t){let{message:e}=t,r=e.split(`
`);return r.length>=4&&/^Parse error on line \d+:$/.test(r[0])&&/^-*\^$/.test(oe(!1,r,-2))?oe(!1,r,-1):r.length>=4&&/:\s?$/.test(r[0])&&/^\(error occurred in '.*?' @ line \d+ : column \d+\)$/.test(oe(!1,r,-1))&&r[1]===""&&oe(!1,r,-2)===""&&r.slice(2,-2).every(n=>n.startsWith("|"))?r[0].trim().slice(0,-1):e}function la(t){let{location:e,hash:r}=t;if(e){let{start:n,end:s}=e;return typeof s.line!="number"?{start:n}:e}if(r){let{loc:{last_line:n,last_column:s}}=r;return{start:{line:n,column:s+1}}}}var ca={parse:aa,astFormat:"glimmer",locStart:Ee,locEnd:et};var ua={glimmer:bn};var ml=Rr;export{ml as default,yn as languages,Ir as parsers,ua as printers};
