    ...
    case 'run_start':
      {
        ...
        if (global[_types.TEST_TIMEOUT_SYMBOL]) {
...
function startTestsConcurrently(concurrentTests) {
  ...
  for (const test of concurrentTests) {
    try {
      ...
      const promise = mutex(() => testNameStorage.run((0, _utils.getTestID)(test), testFn));
...
const unhandledRejectionHandler = (runtime, waitNextEventLoopTurnForUnhandledRejectionEvents) => {
...
const initialize = async ({
  ...
  (0, _state.addEventHandler)((0, _unhandledRejectionHandler.unhandledRejectionHandler)(runtime, globalConfig.waitNextEventLoopTurnForUnhandledRejectionEvents));
