...
$reactionButton-selected-bgColor-hover: #5dadff33;
...
$color-scale-gray-7: #3d424d; // Avoid using scales, use other functional tokens instead
...
$color-scale-blue-4: #5cacff; // Avoid using scales, use other functional tokens instead
...
$color-scale-green-3: #28d751; // Avoid using scales, use other functional tokens instead
$color-scale-green-4: #0ac740; // Avoid using scales, use other functional tokens instead
...
$color-scale-yellow-4: #edaa27; // Avoid using scales, use other functional tokens instead
...
$color-scale-orange-4: #f48b25; // Avoid using scales, use other functional tokens instead
...
$color-scale-red-4: #ff8080; // Avoid using scales, use other functional tokens instead
...
$color-scale-purple-4: #bf8fff; // Avoid using scales, use other functional tokens instead
...
$color-scale-pink-4: #f87cbd; // Avoid using scales, use other functional tokens instead
...
$color-scale-coral-4: #fd8468; // Avoid using scales, use other functional tokens instead
