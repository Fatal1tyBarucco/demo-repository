...
:root {
  ...
  --color-background-row-active: rgb(242, 242, 243);
  ...
  --color-background-row-hover: rgb(249, 249, 250);
  ...
  --color-background-info: rgb(107, 109, 112);
  ...
  --color-background-stencil: rgb(242, 242, 243);
  ...
  --color-background: rgb(249, 249, 250);
  ...
  --color-background-dark: rgb(233, 234, 236);
  ...
  --color-background-offline: rgb(62, 64, 65);
  /* Used as an alternate background for loading stencils on gray backgrounds. */
  --color-background-stencil-alt: rgb(233, 234, 236);
  ...
  --color-background-row-selected: rgb(233, 234, 236);
  ...
  --color-border-info: rgb(107, 109, 112);
  ...
  --color-border-separator-alt-2: rgb(196, 198, 202);
  /* Border color for UI elements related to the offline state. */
  --color-border-offline: rgb(62, 64, 65);
  ...
  --color-border-separator: rgb(249, 249, 250);
  /* Our product brand blue. */
  ...
  --color-border-selection-active: rgb(249, 249, 250);
  ...
  --color-border-separator-alt: rgb(217, 219, 221);
  ...
  --brand-background-primary-transparent: rgba(250, 250, 249, 0);
  /* Variant of BRAND_HEADER that is accessible with BRAND_HEADER */
  ...
  --color-text-action-label: rgb(107, 109, 112);
  ...
  --color-text-weak: rgb(107, 109, 112);
  /* Input placeholder text on dark backgrounds. */
  --color-text-placeholder-inverse: rgb(233, 234, 236);
  /* Link text (508) */
  ...
  /* Default icon color. */
  --color-text-icon-default: rgb(107, 109, 112);
  /* Our product brand blue. */
  ...
  --color-text-placeholder: rgb(107, 109, 112);
  /* Weak inverse text color for dark backgrounds */
  --color-text-inverse-weak: rgb(171, 173, 176);
  ...
  --color-text-label: rgb(107, 109, 112);
  /* Dropdown */
  ...
  --color-contrast-primary: rgb(249, 249, 250);
  ...
  --color-background-alt-2: rgb(242, 242, 243);
  /* Hover color for utility bar item. */
  --color-background-utility-bar-hover: rgb(233, 234, 236);
  ...
  --color-background-brand-primary-focus: rgb(0, 95, 178);
  --color-background-brand-primary-active: rgb(0, 57, 107);
  --color-background-brand-primary-hover: rgb(0, 95, 178);
  ...
  --color-background-browser: rgb(107, 109, 112);
  --color-background-brand-primary: rgb(0, 112, 210);
  ...
  --color-background-shade: rgb(233, 234, 236);
  ...
  --color-background-payload: rgb(249, 249, 250);
  ...
  --color-background-shade-dark: rgb(217, 219, 221);
  /* Notifications badge background color. */
  --color-background-notification-badge-focus: rgb(0, 95, 178);
  /* Background for utility icons that live in the action bar on mobile. */
  --color-background-actionbar-icon-utility: rgb(107, 109, 112);
  --color-background-secondary: rgb(249, 249, 250);
  /* The borders to create the checkmark */
  --color-border-input-checkbox-selected-checkmark: rgb(255, 255, 255);
  /* Disabled stroke color. */
  --color-stroke-disabled: rgb(233, 234, 236);
  /* Active stroke color for our product brand blue. */
  --color-stroke-brand-active: rgb(22, 50, 92);
  --color-border-primary: rgb(217, 219, 221);
  --color-border-brand-primary-focus: rgb(0, 112, 210);
  --color-border-brand-primary-hover: rgb(0, 112, 210);
  /* Border color for brandable primary button */
  --color-border-button-brand: rgb(0, 112, 210);
  --color-border-brand-primary-active: rgb(0, 57, 107);
  --color-border-brand-primary: rgb(21, 137, 238);
  --color-border-button-focus-inverse: rgb(233, 234, 236);
  ...
  --color-stroke-header-button: rgb(171, 173, 176);
  --color-border-link-focus-inverse: rgb(233, 234, 236);
  /* Our product brand blue. */
  ...
  --shadow-link-focus-inverse: 0 0 3px #E9EAEC;
  ...
  --shadow-action-overflow-footer: 0 -2px 4px #F9F9FA;
  /* Deprecated */
  --elevation-0: 0;
  /* Deprecated */
  --elevation-3-inset: -3;
  ...
  --color-text-tab-label-disabled: rgb(233, 234, 236);
  /* Tertiary body text color */
  --color-text-tertiary: rgb(107, 109, 112);
  /* Active state on a standalone link on a dark background. */
  --color-text-inverse-active: rgb(94, 180, 255);
  /* Primary body text color */
  --color-text-primary: rgb(22, 50, 92);
  --color-text-link-primary-focus: rgb(0, 112, 210);
  ...
  --color-text-icon-default-hint-borderless: rgb(233, 234, 236);
  /* Text color for pills. */
  --color-text-pill: rgb(0, 112, 210);
  --color-text-link-primary-hover: rgb(0, 112, 210);
  ...
  --color-text-toast: rgb(233, 234, 236);
  /* Color for disabled toggles */
  --color-text-toggle-disabled: rgb(217, 219, 221);
  /* Top bar icon color */
  --color-text-browser: rgb(255, 255, 255);
  --color-text-link-primary-active: rgb(0, 57, 107);
  --color-text-link-primary: rgb(0, 112, 210);
  ...
  --color-text-inverse-hover: rgb(171, 173, 176);
  /* Modal header title */
  --color-text-modal: rgb(255, 255, 255);
  /* Modal header button text color */
  --color-text-modal-button: rgb(107, 109, 112);
  /* Color for interactive utility icons */
  --color-text-icon-utility: rgb(171, 173, 176);
  /* Secondary body text color */
  --color-text-secondary: rgb(107, 109, 112);
  /* Text in stage left navigation. */
  --color-text-stage-left: rgb(233, 234, 236);
  /* Default value for text-transform */
  --text-transform: none;
  /* Background color for a new notification list item. */
  --color-background-notification-new: rgb(249, 249, 250);
  /* Focused header button icon color */
  --fill-header-button-focus: rgb(0, 112, 210);
  ...
  --color-background-scrollbar: rgb(233, 234, 236);
  /* Disabled toggle background color. */
  --color-background-toggle-disabled: rgb(171, 173, 176);
  /* Background color for toast messaging. */
  --color-background-toast: rgb(107, 109, 112);
  /* Background color of comment posts in the feed. */
  --color-background-post: rgb(249, 249, 250);
  /* Default input field */
  ...
  --color-background-scrollbar-track: rgb(196, 198, 202);
  ...
  --color-border-input-disabled: rgb(196, 198, 202);
  ...
  --shadow-button-focus-inverse: 0 0 3px #E9EAEC;
  ...
  --user-default-avatar: "/assets/images/profile_avatar_200.png";
  --user-default-avatar-medium: "/assets/images/profile_avatar_160.png";
  --user-default-avatar-small: "/assets/images/profile_avatar_96.png";
  --group-default-avatar: "/assets/images/group_avatar_200.png";
  --group-default-avatar-medium: "/assets/images/group_avatar_160.png";
  --group-default-avatar-small: "/assets/images/group_avatar_96.png";
  ...
  /* Input icon */
  --color-text-input-icon: rgb(171, 173, 176);
  ...
  --color-text-button-default-disabled: rgb(217, 219, 221);
  ...
  /* Text color for a button that has a parent element that has a hover state. This is the default text/icon color for that button before its parent has been hovered over. */
  --color-text-button-default-hint: rgb(171, 173, 176);
