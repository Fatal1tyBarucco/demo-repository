...
.slds-file {
  ...
  // Hover state
  &:not(.slds-file_loading) a:hover:before,
  &:not(.slds-file_loading) a:hover:after,
  &:not(.slds-file_loading) a:focus:before,
  &:not(.slds-file_loading) a:focus:after {
    position: absolute;
  ...
  &:not(.slds-file_loading) a:hover + .slds-file__title,
  &:not(.slds-file_loading) a:focus + .slds-file__title {
    z-index: $files-z-index-hover;
  }
  ...
  &.slds-has-title a:hover:after,
  &.slds-has-title a:focus:after {
