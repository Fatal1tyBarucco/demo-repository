...
// Background Color
$_c-theme-button-color-background-inverse: transparent;
$_c-theme-button-color-background-inverse-active: $color-gray-1;

// Border Color
$_c-theme-button-color-border-inverse: $color-gray-1;

// Color
$_c-theme-button-color-disabled: $color-gray-5;
$_c-theme-button-color-inverse: $color-gray-1;
...
// Background Color
$c-button-color-background-default: $color-gray-1;
$c-button-color-background-default-active: $color-gray-2;
$c-button-color-background-brand: $brand-accessible;
$c-button-color-background-brand-active: $brand-accessible-active;
$c-button-color-background-destructive: $color-background-destructive;
$c-button-color-background-destructive-active: $color-background-destructive-active;
$c-button-color-background-success: $color-background-success;
$c-button-color-background-success-active: $color-background-success-dark;

// Border Color

// Border Size
$c-sizing-button-border-width: $border-width-thin;

// Color
$c-theme-button-color: $brand-accessible;
$c-theme-button-color-active: $brand-accessible-active;

// Border Radius
$c-theme-button-border-radius: $border-radius-medium;

// Box Shadow
$c-theme-button-box-shadow: none;
$c-theme-button-box-shadow-active: 0 0 2px $brand-accessible;

// Height
$c-sizing-button-height: $line-height-button;
...
.lwc-button_brand {
  ...
  background-color: var(--c-button-color-background-brand, $c-button-color-background-brand);
  ...
  &:hover,
  &:focus {
    background-color: var(--c-button-color-background-brand-active, $c-button-color-background-brand-active);
...
.lwc-button_inverse {
  @include button-shape;
  background-color: $_c-theme-button-color-background-inverse;
  border-color: $_c-theme-button-color-border-inverse;

  &,
  &:link,
  &:visited {
    color: $_c-theme-button-color-inverse;
  }

  &:hover,
  &:focus,
  &:active {
    background-color: $_c-theme-button-color-background-inverse-active;
...
.lwc-button_neutral {
  @include button-shape;
  border-color: $button-color-border-primary;
  background-color: var(--c-button-color-background-default, $c-button-color-background-default);

  &:hover,
  &:focus {
    background-color: var(--c-button-color-background-default-active, $c-button-color-background-default-active);
  }
