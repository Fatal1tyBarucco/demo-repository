...
.lwc-icon {
  ...
  width: 1rem;
  height: 1rem;
  color: var(--c-theme-icon-color, #706e6b);
  border-radius: var(--c-theme-icon-border-radius, 0.25rem);
...
.lwc-icon-standard-javascript-buttons {
  background-color: #fcb95b; }
...
.lwc-icon_success {
  color: var(--c-theme-icon-color-success, #027e46); }

.lwc-icon_warning {
  color: var(--c-theme-icon-color-warning, #ffb75d); }

.lwc-icon_error {
  color: var(--c-theme-icon-color-error, #c23934); }

.lwc-icon_muted {
  color: var(--c-theme-icon-color-muted, #b0adab); }
